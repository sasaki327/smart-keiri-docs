...
ITツールに不慣れな方でも「迷わず・見落とさず」直感的に操作できることを最優先とし、徹底的な視認性を追求した **OJI-UX（Optimal Judicious Interface）** を採用。最新の **Google Gemini 3.0 Flash** による領収書解析（OCR）と、国税庁API連携によるインボイス監査を統合し、経理実務の正確性をシステムレベルで担保します。
...
導入のご相談やご質問は、**Wantedly 経由でのみ**受け付けています。

- デモ環境を実際に触ってから検討したい方
- 運用方針や価格感に共感いただけた方
- 中長期での安定運用を前提にお考えの方

に向けて、Wantedly上で開発背景やサービスへの想いを詳しく共有しています。下記プロフィールページをご確認のうえ、メッセージにてご連絡ください。

**[Wantedly プロフィール：佐々木 さんのページ](URLをここに記載)**
